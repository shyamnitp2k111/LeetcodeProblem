package company.citi.stock;

/**
 * We are developing a stock.java trading data management software that tracks the prices of different stocks over time
 * and provides useful statistics.
 * <p>
 * The program includes three classes: `Stock`, `PriceRecord`, and `StockCollection`.
 * <p>
 * Classes:
 * The `Stock` class represents data about a specific stock.java.
 * The `PriceRecord` class holds information about a single price record for a stock.java.
 * The `StockCollection` class manages a collection of price records for a particular stock.java and provides methods to
 * retrieve useful statistics about the stock.java's prices.
 * <p>
 ...
 * and returns the largest change in stock.java price between any two consecutive days in the price records of a stock.java
 * along with the dates of the change in a list. For example, let's consider the following price records of a stock.java:
 * <p>
 * Price Records:
 ...
 * Change:              +20              +2             -7
 * <p>
 * In this case, the biggest change in the stock.java price was +20, which occurred between 2023-06-25 and 2023-06-29.
 ...
 * <p>
 * We are currently updating our system to include information about stock.java transactions. As part of this update,
 * we have introduced two new classes:
 * <p>
 * 1. The `Transaction` class represents data about buy/sell transaction of a stock.java. It includes data about the
 * stock.java, the type of transaction (buy/sell), the date of transaction and the quantity of the stocks.
 * <p>
 ...
 * stock.java collection for each stock.java is guaranteed to have the price record for all transaction dates.
 * <p>
...
class Transaction {
    /**
     * Data about a buy/sell transaction of a stock.java.
     */
    Stock stock; // Stock object representing the stock.java
...
class Tradebook {
     ...
     * Approach:
     * 1. Goal:
     *    Calculate total portfolio value based on latest stock.java prices.
     *
     * 2. Step 1: Calculate net quantity of each stock.java
     *    Use a HashMap:
     *      Key   → stock.java name
     ...
     *
     * 3. Step 2: Get latest price for each stock.java
     ...
     *      s = number of stocks
     *      p = price records per stock.java
     *
...
class Stock {
    /**
     * Data about a particular stock.java.
     */
    String symbol; // String, the symbol of the stock.java
    String name; // String, the name of the stock.java
...
class PriceRecord {
    /**
     * Data and methods about a single price record of a stock.java.
     */
    Stock stock; // Stock object representing the stock.java
    int price; // int, the price of the stock.java
...
class StockCollection {
    /**
     * Data for a collection of price records for a particular stock.java, and methods for
     * getting useful statistics about the stock.java's prices.
     */
    ArrayList<PriceRecord> priceRecords = new ArrayList<>(); // list of PriceRecord objects, the price records for this particular stock.java
