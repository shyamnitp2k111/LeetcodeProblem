...
public class ClassLoaderProblem {
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        Class<?> loadClass1 = classLoader1.loadClass("companyinterview.salesforce.LoadingClass");
        ...
        Class<?> loadClass2 = classLoader2.loadClass("companyinterview.salesforce.LoadingClass");
